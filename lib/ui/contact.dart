    ...
    return Container(
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
          ...
          Expanded(
            child: Column(
              children: [
                ...
                _buildUnderlineOrange(
                    Strings.contact_page_finder_1.length),
                Padding(
                  padding: EdgeInsets.only(right: 50.0),
                  child: _buildColumnTextFromList(
                      Strings.contact_page_finder_1_more),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          _buildUnderlineOrange(Strings.contact_page_finder_1.length),
          Padding(
