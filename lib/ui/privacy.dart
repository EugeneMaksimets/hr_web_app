    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            Strings.privacy_sting + ' ' + Strings.politic_sting,
            style: TextStyles.heading.copyWith(
              fontSize: ResponsiveWidget.isSmallScreen(context) ? 26 : 36.0,
              color: Colors.white,
            ),
          ),
          _buildUnderlineOrange(Strings.politic_sting.length),
        ],
      ),
    );
  }
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: _textBuilder(Strings.privacy, TextStyles.menu_item, 15,
                    20, Colors.black),
              ),
              SizedBox(height: 24.0),
              _buildOfferWithFromSecond(),
              SizedBox(
                  height: ResponsiveWidget.isSmallScreen(context) ? 24 : 40),
              _buildContactUs(),
            ],
          ),
        ),
