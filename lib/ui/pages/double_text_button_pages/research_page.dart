...
class ResearchPage extends StatefulWidget {
  ...
  ResearchPage(this.context);

  @override
  _ResearchPage createState() => _ResearchPage();
}
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_research_page_img),
          fit: BoxFit.cover,
        ),
      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            Strings.research_page_text,
            style: TextStyles.heading.copyWith(
              fontSize: ResponsiveWidget.isSmallScreen(context) ? 26 : 36.0,
              color: Colors.white,
            ),
          ),
          _buildUnderlineOrange(Strings.research_page_text.length),
          SizedBox(height: 24),
          Column(
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    _buildColumnTextFromList(Strings.research_page_offer_more),
                  ],
                )
              ]),
        ],
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.research_page_finder_1,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
                      ...
                      _buildUnderlineOrange(
                          Strings.research_page_finder_1.length),
                      Padding(
          ...
          : Column(
              ...
              children: [
                ...
                _buildUnderlineOrange(Strings.research_page_finder_1.length),
                Padding(
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.research_page_finder_2,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
                      ...
                      _buildUnderlineOrange(
                          Strings.research_page_finder_2.length),
                      Padding(
          ...
          : Column(
              children: [
                ...
                _buildUnderlineOrange(Strings.research_page_finder_2.length),
                Padding(
