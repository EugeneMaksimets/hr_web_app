...
class EmployeeDataPage extends StatefulWidget {
  ...
  EmployeeDataPage(this.context);

  @override
  _EmployeeDataPage createState() => _EmployeeDataPage();
}

class _EmployeeDataPage extends State<EmployeeDataPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_employee_data_page_img),
          fit: BoxFit.cover,
        ),
      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            Strings.employee_data_page_text,
            style: TextStyles.heading.copyWith(
              fontSize: ResponsiveWidget.isSmallScreen(context) ? 26 : 36.0,
              color: Colors.white,
            ),
          ),
          _buildUnderlineOrange(Strings.employee_data_page_text.length),
          SizedBox(height: 24),
          Column(
              ...
              children: [
                Text(
                  Strings.employee_data_page_offer,
                  style: TextStyles.logo.copyWith(
                    fontSize:
                ...
                _buildColumnTextFromList(Strings.employee_data_page_offer_more),
              ]),
        ],
      ),
    );
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildUnderlineOrange(
                          Strings.employee_data_page_finder_1.length),
                      Padding(
                ...
                Expanded(
                  child: Column(
                    children: [
                      ...
                      _buildUnderlineOrange(
                          Strings.employee_data_page_finder_2.length),
                      Padding(
