...
class HrPage extends StatefulWidget {
  ...
  @override
  _HrPage createState() => _HrPage();
}

class _HrPage extends State<HrPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_hr_page_img),
          fit: BoxFit.cover,
        ),
      ),
                ...
                !ResponsiveWidget.isSmallScreen(context)
                  ...
                  children: [
                    _buildColumnTextFromList(
                        Strings.hr_page_offer_more_1),
                    SizedBox(width: 50),
                    _buildColumnTextFromList(
                        Strings.hr_page_offer_more_2),
                  ],
                )
                    : Column(
                  mainAxisAlignment: MainAxisAlignment.center,
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
        ...
        children: [
          Expanded(
            child: Column(
              children: [
                Text(
                  Strings.hr_page_finder_1,
                  style: TextStyles.logo.copyWith(
                    fontSize: 30.0,
                    color: Colors.white,
                  ),
                ),
                _buildUnderlineOrange(Strings.hr_page_finder_1.length),
                Padding(
                  padding: EdgeInsets.only(left: 50.0),
                  child: _buildColumnTextFromList(
                      Strings.hr_page_finder_more_1),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.hr_page_finder_more_1),
          ),
          SizedBox(height: 24),
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.hr_page_finder_more_2),
          ),
          Padding(
