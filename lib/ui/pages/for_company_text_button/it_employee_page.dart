...
class ItEmployeePage extends StatefulWidget {
  final BuildContext context;

  ItEmployeePage(this.context);

  @override
  _ItEmployeePage createState() => _ItEmployeePage();
}

class _ItEmployeePage extends State<ItEmployeePage> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            Strings.it_employee_text,
            style: TextStyles.heading.copyWith(
              fontSize: ResponsiveWidget.isSmallScreen(context) ? 26 : 36.0,
              color: Colors.white,
            ),
          ),
          _buildUnderlineOrange(Strings.it_employee_text.length),
          SizedBox(height: 24),
          Column(
              ...
              children: [
                Text(
                  Strings.it_employee_offer_work,
                  style: TextStyles.heading.copyWith(
                    fontSize: 36.0,
                    color: Colors.white,
                  ),
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.it_employee_finder,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
                      ),
                      _buildUnderlineOrange(Strings.it_employee_finder.length),
                      Padding(
                        padding: EdgeInsets.only(left: 50.0),
                        child: _buildColumnTextFromList(
                            Strings.it_employee_finder_more),
                      ),
                    ],
                  ),
                ),
          ...
          : Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child:
                      _buildColumnTextFromList(Strings.it_employee_finder_more),
                ),
                SizedBox(height: 24),
