...
class AdministrationPage extends StatefulWidget {
  ...
  AdministrationPage(this.context);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_administration_page_img),
          fit: BoxFit.cover,
        ),
      ),
        ...
        children: [
          ...
          !ResponsiveWidget.isSmallScreen(context)
              ? Column(
                  ...
                  children: [
                      Text(
                        Strings.administration_work_offer,
                        style: TextStyles.heading.copyWith(
                          fontSize: 20.0,
                          color: Colors.white,
                        ),
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
              ...
              children: [
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.administration_finder_1,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
                      ...
                      _buildUnderlineOrange(
                          Strings.administration_finder_1.length),
                      Padding(
          ...
          : Column(
              ...
              children: [
                ...
                _buildUnderlineOrange(Strings.administration_finder_1.length),
                Padding(
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.administration_finder_2,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
                      ...
                      _buildUnderlineOrange(
                          Strings.administration_finder_2.length),
                      Padding(
          ...
          : Column(
              children: [
                ...
                _buildUnderlineOrange(Strings.administration_finder_2.length),
                Padding(
