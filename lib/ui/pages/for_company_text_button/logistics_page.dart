...
class LogisticsPage extends StatefulWidget {
  ...
  LogisticsPage(this.context);

  @override
  _LogisticsPage createState() => _LogisticsPage();
}

class _LogisticsPage extends State<LogisticsPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_logistics_page_img),
          fit: BoxFit.cover,
        ),
      ),
                ...
                !ResponsiveWidget.isSmallScreen(context)
                  ...
                  children: [
                    _buildColumnTextFromList(
                        Strings.logistics_offer_1_more),
                    SizedBox(width: 50),
                    _buildColumnTextFromList(
                        Strings.logistics_offer_2_more),
                  ],
                )
                    : Column(
                  mainAxisAlignment: MainAxisAlignment.center,
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
        ...
        children: [
          Expanded(
            child: Column(
              children: [
                Text(
                  Strings.logistics_finder_1,
                  style: TextStyles.logo.copyWith(
                    fontSize: 30.0,
                    color: Colors.white,
                  ),
                ),
                _buildUnderlineOrange(Strings.logistics_finder_1.length),
                Padding(
                  padding: EdgeInsets.only(left: 50.0),
                  child: _buildColumnTextFromList(
                      Strings.logistics_finder_1_more),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.logistics_finder_1_more),
          ),
          SizedBox(height: 24),
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
        ...
        children: [
          ...
          Expanded(
            child: Column(
              children: [
                Text(
                  Strings.logistics_finder_2,
                  style: TextStyles.logo.copyWith(
                    fontSize: 30.0,
                    color: Colors.white,
                  ),
                ),
                _buildUnderlineOrange(Strings.logistics_finder_2.length),
                Padding(
                  padding: EdgeInsets.only(right: 50.0),
                  child: _buildColumnTextFromList(
                      Strings.logistics_finder_2_more),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.logistics_finder_2_more),
          ),
          Padding(
