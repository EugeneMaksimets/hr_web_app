...
class SalesMangerPage extends StatefulWidget {
  final BuildContext context;

  SalesMangerPage(this.context);

  @override
  _SalesMangerPage createState() => _SalesMangerPage();
}

class _SalesMangerPage extends State<SalesMangerPage> {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_sales_manager_page_img),
          fit: BoxFit.cover,
        ),
      ),
              ...
              ? Row(
                  ...
                  children: [
                      Column(
                        ...
                        children: [
                          Text(
                            Strings.sales_manager_offer_work_1,
                            style: TextStyles.heading.copyWith(
                              fontSize: 20.0,
                              color: Colors.white,
                            ),
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    children: [
                      Text(
                        Strings.sales_manager_finder_2,
                        style: TextStyles.logo.copyWith(
                          fontSize: 30.0,
                          color: Colors.white,
                        ),
