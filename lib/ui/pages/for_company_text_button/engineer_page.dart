...
class EngineerPage extends StatefulWidget {
  ...
  EngineerPage(this.context);

  @override
  _EngineerPage createState() => _EngineerPage();
}
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage(Assets.background_engineer_page_img),
          fit: BoxFit.cover,
        ),
      ),
      ...
      child: Column(
        children: [
          ...
          Text(
            Strings.engineer_text,
            style: TextStyles.heading.copyWith(
              fontSize: ResponsiveWidget.isSmallScreen(context) ? 26 : 36.0,
              color: Colors.white,
            ),
          ),
          _buildUnderlineOrange(Strings.engineer_text.length),
          SizedBox(height: 24),
          Column(
                ...
                !ResponsiveWidget.isSmallScreen(context)
                  ...
                  children: [
                    _buildColumnTextFromList(
                        Strings.engineer_offer_1_more),
                    SizedBox(width: 50),
                    _buildColumnTextFromList(
                        Strings.engineer_offer_2_more),
                  ],
                )
                    : Column(
                  mainAxisAlignment: MainAxisAlignment.center,
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
        ...
        children: [
          Expanded(
            child: Column(
              children: [
                Text(
                  Strings.engineer_finder_1,
                  style: TextStyles.logo.copyWith(
                    fontSize: 30.0,
                    color: Colors.white,
                  ),
                ),
                _buildUnderlineOrange(Strings.engineer_finder_1.length),
                Padding(
                  padding: EdgeInsets.only(left: 50.0),
                  child: _buildColumnTextFromList(
                      Strings.engineer_finder_1_more),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.engineer_finder_1_more),
          ),
          SizedBox(height: 24),
      ...
      child: !ResponsiveWidget.isSmallScreen(context)
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: _buildColumnTextFromList(
                      Strings.engineer_finder_2_more),
                ),
              ],
            ),
          ),
        ...
        children: [
          ...
          Padding(
            ...
            child:
            _buildColumnTextFromList(Strings.engineer_finder_2_more),
          ),
          Padding(
