                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              CompanyRegistrationPage(context),
                        ),
                      );
                    },
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(10.0),
                        child: Text(
                          Strings.sign_in + ' ' + Strings.like_company,
                          style:
                      ...
                      onPressed: () {
                        if ((_formKey.currentState?.validate() ?? false) &&
                            Data.getConnection()) {
                          if (Data.signInCompany(_email, _password)) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>
                                      CompanyProfilePage(context)),
                            );
                          } else {
                            CompanyRegistrationPage.error =
                                Strings.email_not_founded;
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) =>
